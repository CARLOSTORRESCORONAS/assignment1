...
public class DownloadImageService extends IntentService {
    ...
    public static Intent makeIntent(Context context,
        ...
        // (1) Set the URI as data in the Intent.
        intent.setData(url);

        // (2) Create and pass a Messenger as an "extra" so the
    ...
    public void onHandleIntent(Intent intent) {
        ...
        String url = getImageURL(intent.getExtras());
        // Get the directory pathname where the image will be stored.
        // @@ TODO -- you fill in here.
        String pathname = getImagePathname(intent.getExtras());
        // Download the requested image.
        // @@ TODO -- you fill in here.
        Utils.downloadImage(DownloadImageService.this, Uri.parse(url), pathname);
        ...
        // @@ TODO -- you fill in here.
        sendPath(messenger, Uri.parse(pathname), Uri.parse(url));
